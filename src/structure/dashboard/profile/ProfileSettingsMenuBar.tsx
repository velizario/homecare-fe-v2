...
export default function ProfileSettingsMenuBar() {

  return (
    <>
        <nav
            aria-label="Sections"
            className="hidden w-full max-w-sm flex-shrink-0 border-r border-blue-gray-200 bg-white lg:flex xl:flex-col"
        >
