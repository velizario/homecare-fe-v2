...
export default function ComboSingleSelect({
  selected,
  setSelected,
  selections,
  disabled
}: ComboSingleSelectProps) {
  ...
  return (
    <Combobox as="div" disabled={disabled} value={selected} onChange={setSelected}>
      <div className="relative">
        <Combobox.Input
          className={classNames(disabled ? "bg-gray-50 text-gray-600" : "bg-white text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600", "w-full rounded-md border-0 py-1.5 pl-3 pr-10  sm:text-sm sm:leading-6")}
