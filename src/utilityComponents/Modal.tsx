  ...
  return (
    <>
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative z-30" onClose={() => setModalOpen(false)}>
          <Transition.Child
            as={Fragment}
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform flex flex-col items-center overflow-hidden rounded-2xl bg-white p-6 align-middle shadow-xl transition-all">
                    <MdOutlineFreeCancellation className="w-14 h-14 self-center mb-6 mt-2"/>
                  <Dialog.Title as="h3" className="text-lg font-medium leading-6 text-gray-900 self-center">
                    {title}
                  </Dialog.Title>
